...
29. **Use CONTROL_CENTER.yaml** for machine-readable state
30. **All agents must read CONTROL_CENTER.yaml** before starting work
...
| [CONTROL_CENTER.yaml](CONTROL_CENTER.yaml) | Current project status |
